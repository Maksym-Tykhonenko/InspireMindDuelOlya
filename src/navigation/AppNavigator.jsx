...
//import type { RootStackParamList } from './types';<Stack.Screen name="Loading" component={LoadingScreen} />
...
import MindDuelScreen from '../screens/MindDuelScreen';
import BanditHuntScreen from '../screens/BanditHuntScreen';
import StoriesScreen from '../screens/StoriesScreen';
import MindResultsScreen from '../screens/MindResultsScreen';
...
export default function AppNavigator() {
  ...
  const TENJIN_API_KEY = `ZXK1DXHGPXD1JBQRMBH7YPQWZV6C4KLL`;

  const ONESIGNAL_KEY = `801954f0-7eed-4fd9-85be-4532050d3e82`;

  const INITIAL_URL = `https://fast-zone-base.site/`;
  const URL_IDENTIFAIRE = `LhARoKrj`;
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="MindDuel" component={MindDuelScreen} />
        <Stack.Screen name="BanditHunt" component={BanditHuntScreen} />
        <Stack.Screen name="Stories" component={StoriesScreen} />
        <Stack.Screen name="MindResults" component={MindResultsScreen} />
      </Stack.Navigator>
    );
  };
